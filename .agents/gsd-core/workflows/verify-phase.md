...
<required_reading>
@.agents/gsd-core/references/verification-patterns.md
@.agents/gsd-core/templates/verification-report.md
</required_reading>
...
See .agents/gsd-core/templates/verification-report.md for complete template.
</step>
